...
<head>
    ...
    <title>Accept your invitation &middot; {{ config('app.name', 'Synapse') }}</title>
    <style>
...
<body>
    <div class="card">
        ...
        <form method="POST" action="{{ url('/'.$loginPath.'/invite/'.$token) }}">
            @csrf
            <div class="field">
